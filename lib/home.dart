...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> listInfos = [
      ...
      'Cocorra a prêmios com NuBank Vida a partir de R\$ ...',
      'Convide amigos par ao NuBank e desbloqueie ...',
    ];
    ...
    final List<Map<String, String>> listFindOutMore = [
      ...
      },
      {
        ...
        "title": "Indique o NuBnak para amigos",
      ...
      },
      {
        ...
        "title": "Termos de uso",
        "description": "Explicamos o que diz esse documento Nubank",
        "buttonTitle": "Conhecer"
      },
    ];

    final List<Map<String, String>> listPhoto = [
      {
                ...
                children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              const SizedBox(
                                child: CircleAvatar(
                                  backgroundImage:
                                      AssetImage("assets/images/julius.jpg"),
                                ),
                              ),
                              Row(
                                children: const [
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: const [
                            Text('Conta', style: textStyleTitles),
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Container(
                              margin: EdgeInsets.only(
                                  left: index == 0 ? 20 : 0,
                                  right: index == (listInfos.length - 1)
                                      ? 20
                                      : 15),
                              width: 260,
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: const [
                            Text('Cartão de crédito', style: textStyleTitles),
                            Icon(Icons.keyboard_arrow_right_rounded),
                          ],
                        ),
                        const SizedBox(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('Acompanhe também', style: textStyleTitles),
                        Container(
                          height: 70,
                          padding: const EdgeInsets.fromLTRB(15, 0, 15, 0),
                          ...
                          child: Row(
                            children: const [
                              Icon(Icons.currency_exchange_rounded, size: 22),
                              SizedBox(width: 12),
                              Text(
